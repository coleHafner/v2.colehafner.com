...
.controller('ProjectsCtrl', ['$scope', '$q', function($scope, $q) {
	...
	ctrl.projects = [{
			...
			tags: ['angular', 'php', 'mysql', 'highcharts', 'html5', 'css', 'grunt', 'bower', 'composer', 'vagrant', 'TCPDF', 'sass'],
			...
			tags: ['angular', 'php', 'mysql', 'highcharts', 'html5', 'css', 'grunt', 'bower', 'composer', 'vagrant', 'sass'],
